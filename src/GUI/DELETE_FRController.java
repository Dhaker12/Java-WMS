 ...
 * @author khaoula
 */
public class DELETE_FRController implements Initializable {

    @FXML
    private TextField id;
    @FXML
    private Button delete;
public int idd= READ_FRController.deleteid;        
...
private Connection connection = ConnexionBD.getinstance().getcnx();
    ...
    private void delete(ActionEvent event) throws IOException {
        ...
        try {
            ...
            pre.setInt(1, test);
            pre.executeUpdate();
            Parent home_page_parent =FXMLLoader.load(getClass().getResource("done.fxml"));
